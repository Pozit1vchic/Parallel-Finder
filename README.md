...
[Начать](#первый-запуск) · [Выбрать модель](#какую-модель-выбрать) · [Ускорение](#cpu-directml-cuda-и-tensorrt) · [Ограничения](#честно-о-результатах)

</div>

<p align="center"><img src="docs/assets/readme-hero.svg" alt="Параллель: два фрагмента A и B для сравнения" width="100%"></p>
...
2. **Откройте настройки** и выберите pose-модель. Если модель отсутствует, нажмите вариант с отметкой скачивания и дождитесь завершения.
...
Включите **«Костюм / маска»** для закрытых лиц. Приложение сравнивает внешний вид тела и движения без распознавания лица.
