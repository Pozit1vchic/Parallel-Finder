...
L2-нормированный прототип; совпадение допускается только при cosine similarity
не ниже `0.78`, после чего appearance-сигнал получает 30% итогового score.
Это identity-gate против похожих поз разных людей, а не доказательство
